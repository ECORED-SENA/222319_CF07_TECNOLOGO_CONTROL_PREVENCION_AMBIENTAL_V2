...
.curso-main-container.pb-3
  BannerInterno
  .container.tarjeta.tarjeta--blanca.pb-0.p-4.pb-md-0.p-md-5.mb-5
    ...
    h3.subt.text-white.mb-4(data-aos="fade") Parámetros de análisis físicos, químicos y microbiológicos el agua
    ...
    h3.subt.text-white.mb-4(data-aos="fade") Parámetros de análisis físicos, químicos y microbiológicos del suelo
    ...
    h3.subt.text-white.mb-4(data-aos="fade") Parámetros de análisis físicos, químicos y microbiológicos del olor
    ...
    p.mb-4(data-aos="fade") En este tema encontramos:

    AcordionA(data-aos="fade-down" tipo="a" clase-tarjeta="tarjeta bg-gris3")
      .row.justify-content-center(titulo="Caracterización física")
        .col-md-8
      ...
      .row.justify-content-center(titulo="Capacidad de campo")
        .col-md-6.mb-4
